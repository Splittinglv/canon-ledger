...
> 可选的力量体系灵感，仅在用户明确需要时读取。插件不要求升级、越级、数值成长或固定节奏；只有作者明确认证的机械规则才进入事实检查。
...
是否允许越级、允许多少以及是否存在等级体系都由作者决定。若作者把边界认证为硬规则，后续只检查正文是否与该明确规则冲突。
