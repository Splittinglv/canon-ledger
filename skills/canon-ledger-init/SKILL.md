...
必收：书名、题材（支持 A+B 复合）、目标规模（总字数或总章数）、一句话故事、核心冲突。
不说就不问、不阻断：目标读者、平台、商业定位。
...
必收：主角姓名、主角欲望、主角缺陷（会害他付代价）。
不说就不问、不阻断：主角结构（单/多主角）、感情线配置（无/单女主/多女主）、主角原型标签、多主角分工。对立角色、组织、环境或规则压力均为可选；只收用户已经确定的名称、目标和与主角的事实关系，不默认补小/中/大层级。
...
必收：世界规模（单城/多域/大陆/多界）、力量体系类型。
不说就不问、不阻断：势力格局、社会阶层与资源分配、货币体系、宗门/组织层级、境界链。
题材相关字段有则写、没有不补。
