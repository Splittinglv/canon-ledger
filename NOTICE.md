...
在 Splittinglv 发起的产品方向下，本项目使用生成式 AI 工具辅助完成了 Cursor 宿主适配，并将默认产品边界重构为长篇小说长期事实一致性。当前 Canon v3 以单一不可变 HEAD 保存和重放作者已认证硬设定、正文绑定的人物状态、关系、知识、在场、物品持有、时间、规则、伏笔与承诺；关键或实质歧义节点默认交作者做精确绑定的人工决定。长期硬设定通过 managed author-axiom 通道新增、修改或删除，新项目直接建立原生 Canon genesis。章纲目标保持 advisory，文风、文笔、人物动机与剧情取舍留给作者和所选模型，不作为默认事实门禁。
