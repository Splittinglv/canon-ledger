...
## v7.0.0 - 叙典 CanonLedger 独立产品身份

发版范围：`v6.2.2..v7.0.0`。

### 给作者看的变化

- 产品更名为“叙典 CanonLedger”，定位为由 Splittinglv 独立维护的长篇小说一致性引擎。
...
- 插件产品名、slug 和当前维护者改为 `CanonLedger`、`canon-ledger` 与 `Splittinglv`；当前仓库 URL 在完成独立迁移前保持真实可达地址。
